...
export default function Flashcards({
  ...
  const botoes = [
    {
      texto: "Não lembrei",
      cor: "VERMELHO",
      icone: "../assets/img/icone_erro.png",
      data_identifier: "forgot-btn",
    },
    {
      texto: "Quase não lembrei",
      cor: "AMARELO",
      icone: "../assets/img/icone_quase.png",
      data_identifier: "almost-forgot-btn",
    },
    {
      texto: "Zap!",
      cor: "VERDE",
      icone: "../assets/img/icone_certo.png",
      data_identifier: "zap-btn",
    },
  ];
  ...
  return <>{perguntasSelecionadas.map((p, i) => renderizarPergunta(p, i))}</>;
}
...
const PerguntaFechada = styled.div`
  ...
  p {
    ...
    text-decoration: ${(props) =>
      ["VERDE", "AMARELO", "VERMELHO"].includes(props.color)
        ? "line-through"
        : ""};
  }
  img {
...
const Botao = styled.button`
  ...
  color: #ffffff;
  background: ${(props) =>
    props.background === "VERDE"
      ? "#2FBE34"
      : props.background === "AMARELO"
      ? "#FF922E"
      : props.background === "VERMELHO"
      ? "#FF3030"
      : "#333333"};
  border: 1px solid
    ${(props) =>
